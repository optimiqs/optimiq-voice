...
[![Autopilot](https://img.shields.io/badge/autopilot-api-brightgreen.svg)](https://optimiq.health)
[![Version](https://img.shields.io/npm/v/@optimiq-voice/autopilot.svg)](https://npmjs.org/package/@optimiq-voice/autopilot)
[![Downloads/week](https://img.shields.io/npm/dw/@optimiq-voice/autopilot.svg)](https://npmjs.org/package/@optimiq-voice/autopilot)
[![License](https://img.shields.io/npm/l/@optimiq-voice/autopilot.svg)](https://github.com/optimiqs/optimiq-voice/blob/main/package.json)

The autopilot module provides a way to create Voice AI applications in Optimiq Voice. It uses Optimiq Voice internal Voice API and the power of Large Language Models to create a conversational experience with the calling party.
...
```sh-session
$ npm install -g @optimiq-voice/autopilot
```
...
To function, Autopilot needs a configuration file, an OpenAI API key, and an active Optimiq Voice account or self-hosted Optimiq Voice instance.
...
Take the endpoint provided by ngrok and configure it in your Optimiq Voice account. You can find more information about how to do this in the [Optimiq Voice documentation](https://optimiq.health/docs).
