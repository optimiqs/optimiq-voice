...
import { WELCOME_DEMO_SPECIAL_LOCAL_ADDRESS } from "@optimiq-voice/common";
import * as SDK from "@optimiq-voice/sdk";
import { CreateApplicationRequest } from "@optimiq-voice/types";
...
export default class Create extends AuthenticatedCommand<typeof Create> {
	static override readonly description = "add a new Application to the active Workspace";
