...
export default class Create extends AuthenticatedCommand<typeof Create> {
	static override readonly description = "add a new set of Credentials to the network";
	...
	public async run(): Promise<void> {
		...
		try {
			...
			await credentials.createCredentials(answers as unknown as CreateCredentialsRequest);
