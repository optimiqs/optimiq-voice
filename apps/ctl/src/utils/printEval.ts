...
export function printStepResult(
	...
	const passedStr = step.passed ? ansis.green("✔ Passed") : ansis.red("✘ Failed");
 ...
 */
export function printScenarioSummary(scenarioRef: string, overallPassed: boolean): void {
	console.log(
		ansis.bold(`  Overall: ${overallPassed ? ansis.green("✔ Passed") : ansis.red("✘ Failed")}`),
	);
}
