...
function prepareForValidation(request: CreateApplicationRequest | UpdateApplicationRequest) {
	...
	const createProperty = (property) => {
		return property
			? {
					...
					credentials: property.credentials ? struct.decode(property.credentials) : undefined,
