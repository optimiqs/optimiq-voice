...
export const ASTERISK_SYSTEM_DOMAIN =
  e.API_ASTERISK_SYSTEM_DOMAIN || "sip.invalid";
...
export const HTTP_BRIDGE_PORT = e.API_HTTP_BRIDGE_PORT
  ? parseInt(e.API_HTTP_BRIDGE_PORT)
  : 9876;

// Identity configurations
export const IDENTITY_ACCESS_TOKEN_EXPIRES_IN =
  e.API_IDENTITY_ACCESS_TOKEN_EXPIRES_IN || "15m";

export const IDENTITY_AUDIENCE = e.API_IDENTITY_AUDIENCE || "api";

export const IDENTITY_ID_TOKEN_EXPIRES_IN =
  e.API_IDENTITY_ID_TOKEN_EXPIRES_IN || "15m";
...
export const IDENTITY_OAUTH2_GITHUB_ENABLED =
  e.API_IDENTITY_OAUTH2_GITHUB_ENABLED === "true";

export const IDENTITY_OAUTH2_GITHUB_CLIENT_ID =
  e.API_IDENTITY_OAUTH2_GITHUB_CLIENT_ID;

export const IDENTITY_OAUTH2_GITHUB_CLIENT_SECRET =
  e.API_IDENTITY_OAUTH2_GITHUB_CLIENT_SECRET;
...
export const IDENTITY_REFRESH_TOKEN_EXPIRES_IN =
  e.API_IDENTITY_REFRESH_TOKEN_EXPIRES_IN || "24h";

export const IDENTITY_WORKSPACE_INVITE_FAIL_URL =
  e.API_IDENTITY_WORKSPACE_INVITE_FAIL_URL;
...
export const IDENTITY_WORKSPACE_INVITE_URL =
  e.API_IDENTITY_WORKSPACE_INVITE_URL;
...
export const INTEGRATIONS_FILE =
  e.API_INTEGRATIONS_FILE || "/opt/optimiq-voice/integrations.json";
...
export const ROUTR_DEFAULT_PEER_AOR =
  e.API_ROUTR_DEFAULT_PEER_AOR || "sip:voice@default";

export const ROUTR_DEFAULT_PEER_NAME =
  e.API_ROUTR_DEFAULT_PEER_NAME || "Voice Server";
...
export const ROUTR_DEFAULT_PEER_USERNAME =
  e.API_ROUTR_DEFAULT_PEER_USERNAME || "voice";
