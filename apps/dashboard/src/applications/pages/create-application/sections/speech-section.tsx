...
import { STT_MODELS, LANGUAGES, STT_VENDORS, TTS_VENDORS } from "../create-application.const";
		...
		<>
			<Box sx={{ mt: "8px" }}>
				...
				<Typography variant="body-micro" color="base.03">
					Select the Speech-to-Text vendor and model that best fit your use case. Check the vendor's
					documentation for the languages supported by each model.
				</Typography>
			</Box>
			...
			<Box sx={{ mt: "8px" }}>
				...
				<Typography variant="body-micro" color="base.03">
					Select the Text-to-Speech vendor and voice that best fit your use case. Check the vendor's
					documentation for the languages supported by each voice.
				</Typography>
			</Box>
