...
import { useApplication, useUpdateApplication } from "~/applications/services/applications.service";
		...
		<>
			<Page variant="form">
					...
					actions={
						<Box sx={{ display: "flex", gap: 1, flexDirection: "column" }}>
							...
							<Button
								...
								startIcon={
									<Icon name="Phone" sx={{ fontSize: "16px !important", color: "inherit" }} />
								}
							>
								{isCalling && !isAnswered ? "Calling..." : isAnswered ? "Hangup" : "Test Call"}
							</Button>
						</Box>
					}
				/>
				...
				<Box sx={{ maxWidth: "440px" }}>
					<CreateApplicationForm onSubmit={onSave} initialValues={data as Schema} isEdit={true} />
				</Box>
			</Page>
