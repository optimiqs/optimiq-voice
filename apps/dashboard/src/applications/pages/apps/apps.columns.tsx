...
export const columns: ColumnDef<Application>[] = [
	...
	},
	{
		...
		cell: ({ row }) => formatEngineName(row.original.textToSpeech?.productRef, "tts."),
	},
	{
		/**
		...
		cell: ({ row }) => formatEngineName(row.original.speechToText?.productRef, "stt."),
	},
	{
		id: "intelligence",
		header: "Intelligence",
		accessorKey: "intelligence.productRef",
		cell: ({ row }) => formatEngineName(row.original.intelligence?.productRef, "llm."),
	},
	{
		/**
