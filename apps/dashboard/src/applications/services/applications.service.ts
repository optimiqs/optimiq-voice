...
/**
 * Hook to fetch the list of applications using the Optimiq Voice SDK.
 *
...
/**
 * Hook to fetch a specific application by its reference using the Optimiq Voice SDK.
 *
...
/**
 * Hook to create a new application using the Optimiq Voice SDK with optimistic UI updates.
 *
...
/**
 * Hook to update an existing application using the Optimiq Voice SDK with optimistic UI support.
 *
...
/**
 * Hook to delete an application by reference using the Optimiq Voice SDK with optimistic cache updates.
 *
