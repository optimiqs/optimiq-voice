...
/**
 * Hook to fetch the list of apiKeys using the Optimiq Voice SDK.
 *
...
/**
 * Hook to create a new apiKey using the Optimiq Voice SDK with optimistic UI updates.
 *
...
/**
 * Hook to delete an apiKey by reference using the Optimiq Voice SDK with optimistic cache updates.
 *
