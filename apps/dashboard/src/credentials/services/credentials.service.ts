...
/**
 * Hook to fetch the list of credentials using the Optimiq Voice SDK.
 *
...
/**
 * Hook to fetch a specific credential by its reference using the Optimiq Voice SDK.
 *
...
/**
 * Hook to create a new credential using the Optimiq Voice SDK with optimistic UI updates.
 *
...
/**
 * Hook to update an existing credential using the Optimiq Voice SDK with optimistic UI support.
 *
...
/**
 * Hook to delete an credential by reference using the Optimiq Voice SDK with optimistic cache updates.
 *
