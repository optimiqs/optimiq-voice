...
/**
 * Hook to fetch the list of numbers using the Optimiq Voice SDK.
 *
...
/**
 * Hook to fetch a specific number by its reference using the Optimiq Voice SDK.
 *
...
/**
 * Hook to create a new number using the Optimiq Voice SDK with optimistic UI updates.
 *
...
/**
 * Hook to update an existing number using the Optimiq Voice SDK with optimistic UI support.
 *
...
/**
 * Hook to delete an number by reference using the Optimiq Voice SDK with optimistic cache updates.
 *
