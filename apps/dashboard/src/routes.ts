...
export default [
	...
	...prefix("auth", [
		...
		layout("auth/components/layouts/authentication-flow.layout.tsx", [
			 ...
			 */
			route("forgot-password", "auth/pages/forgot-password/forgot-password.page.tsx"),
			 ...
			 */
			route("reset-password", "auth/pages/reset-password/reset-password.page.tsx"),
		]),
	]),
	...
	layout("core/components/layouts/authenticated.layout.tsx", [
		...
		layout("core/components/layouts/app-shell.layout.tsx", [
			...
			...prefix("workspaces/:workspaceId", [
				 ...
				 */
				route("members", "workspaces/pages/[workspace]/members/members.page.tsx"),
				 ...
				 */
				route("settings", "workspaces/pages/[workspace]/settings/settings.page.tsx"),
				...
				...prefix("applications", [
					 ...
					 */
					route("create", "applications/pages/create-application/create-application.page.tsx"),
					 ...
					 */
					route("/:ref/edit", "applications/pages/edit-application/edit-application.page.tsx"),
				]),
				...
				...prefix("sip-network", [
					...
					...prefix("numbers", [
						 ...
						 */
						route("create", "numbers/pages/create-number/create-number.page.tsx"),
						 ...
						 */
						route("/:ref/edit", "numbers/pages/edit-number/edit-number.page.tsx"),
					]),
					...
					...prefix("domains", [
						 ...
						 */
						route("create", "domains/pages/create-domain/create-domain.page.tsx"),
						 ...
						 */
						route("/:ref/edit", "domains/pages/edit-domain/edit-domain.page.tsx"),
					]),
					...
					...prefix("credentials", [
						 ...
						 */
						route("create", "credentials/pages/create-credential/create-credential.page.tsx"),
						 ...
						 */
						route("/:ref/edit", "credentials/pages/edit-credential/edit-credential.page.tsx"),
					]),
				]),
				...
				...prefix("api-keys", [
					 ...
					 */
					route("create", "api-keys/pages/create-api-key/create-api-key.page.tsx"),
				]),
