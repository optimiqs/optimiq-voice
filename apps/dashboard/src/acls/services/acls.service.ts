...
/**
 * Hook to fetch the list of acls using the Optimiq Voice SDK.
 *
...
/**
 * Hook to fetch a specific acl by its reference using the Optimiq Voice SDK.
 *
...
/**
 * Hook to create a new acl using the Optimiq Voice SDK with optimistic UI updates.
 *
...
/**
 * Hook to update an existing acl using the Optimiq Voice SDK with optimistic UI support.
 *
...
/**
 * Hook to delete an acl by reference using the Optimiq Voice SDK with optimistic cache updates.
 *
