...
import { ForgotPasswordForm, type Form, type Schema } from "./forgot-password.form";
...
export default function ForgotPasswordPage() {
	...
	const onSubmit = useCallback(async ({ email: username }: Schema, form: Form) => {
		Logger.debug("[<ForgotPasswordPage />]: Submitting forgot password form with data:", {
			username,
		});
		await mutateAsync({
			username,
