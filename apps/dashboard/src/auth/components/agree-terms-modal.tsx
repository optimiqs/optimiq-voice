    ...
    >
      ...
      >
        <Typography variant="body-small" color="base.03">
          Welcome to Optimiq Voice ("Optimiq Voice," "we," "our," or "us").
          These Terms and Conditions ("Terms") govern your access to and use of
          our platform and related services (collectively, the "Services"). By
        ...
        <Typography variant="body-small" color="base.03">
          Optimiq Voice provides a cloud-based programmable telecommunications
        ...
        <Typography variant="body-small" color="base.03">
          ...
          <br />• You may cancel at any time via your account settings <br />•
        ...
        <Typography variant="body-small" color="base.03">
          All content, trademarks, logos, and software associated with Optimiq
          Voice Services are owned by Optimiq Voice or its licensors. You are
          granted a limited, non-exclusive, non-transferable right to use the
        ...
        <Typography variant="body-small" color="base.03">
          ...
          speech recognition APIs). Optimiq Voice is not responsible for the
        ...
        <Typography variant="body-small" color="base.03">
          The Services are provided "as is" and "as available." Optimiq Voice
        ...
        <Typography variant="body-small" color="base.03">
          To the maximum extent permitted by law, Optimiq Voice shall not be
          liable for any indirect, incidental, special, or consequential
          damages. Optimiq Voice's total liability for any claim shall not
          exceed the greater of (i) the amount paid by you in the 12 months
          prior to the claim or (ii) $100.
        </Typography>

        <Typography variant="heading-small">10. Indemnification</Typography>
        <Typography variant="body-small" color="base.03">
          You agree to indemnify and hold Optimiq Voice, its affiliates, and
          their officers, directors, employees, and agents harmless from any
          claims, damages, liabilities, costs, or expenses arising out of your
        ...
        <Typography variant="body-small" color="base.03">
          ...
          team@optimiq.health or visit www.optimiq.health.
        </Typography>
