...
/**
 * Hook to fetch the list of users using the Optimiq Voice SDK.
 *
...
/**
 * Hook to fetch a specific user by its reference using the Optimiq Voice SDK.
 *
...
/**
 * Hook to create a new user using the Optimiq Voice SDK with optimistic UI updates.
 *
...
/**
 * Hook to update an existing user using the Optimiq Voice SDK with optimistic UI support.
 *
...
/**
 * Hook to delete an user by reference using the Optimiq Voice SDK with optimistic cache updates.
 *
...
/**
 * Hook to send a password reset code to a user using the Optimiq Voice SDK.
 *
...
/**
 * Hook to reset a user's password using the Optimiq Voice SDK.
 *
 * This hook uses React Query's `useMutation` to:
