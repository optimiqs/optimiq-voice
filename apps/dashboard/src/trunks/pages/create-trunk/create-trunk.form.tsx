...
export function CreateTrunkForm({ onSubmit, initialValues, isEdit }: CreateTrunkFormProps) {
	const [isTrunkCredentialsModalOpen, setIsTrunkCredentialsModalOpen] = useState(false);
	...
	const [credentialsModalField, setCredentialsModalField] =
		useState<string>("inboundCredentialsRef");
				...
				<FormRoot onSubmit={form.handleSubmit(onSubmit)}>
					...
					<Box sx={{ mt: "8px" }}>
						...
						<Typography variant="body-micro" color="base.03">
							Outgoing traffic from your communications infrastructure to the PSTN. In order to use
							a Trunk for termination it must have a Termination SIP URI and at least one
							authentication scheme (IP Access Control Lists and/or Credential Lists).
						</Typography>
					</Box>
