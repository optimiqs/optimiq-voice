...
/**
 * Hook to fetch the list of trunks using the Optimiq Voice SDK.
 *
...
/**
 * Hook to fetch a specific trunk by its reference using the Optimiq Voice SDK.
 *
...
/**
 * Hook to create a new trunk using the Optimiq Voice SDK with optimistic UI updates.
 *
...
/**
 * Hook to update an existing trunk using the Optimiq Voice SDK with optimistic UI support.
 *
...
/**
 * Hook to delete an trunk by reference using the Optimiq Voice SDK with optimistic cache updates.
 *
