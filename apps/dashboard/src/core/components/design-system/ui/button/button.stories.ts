...
const meta = {
	...
	argTypes: {
		variant: {
			name: "Variant",
			description:
				"Based on the Optimiq Voice design system, the variant prop determines the color and style of the button.",
			control: { type: "select" },
			table: {
				defaultValue: {
					summary: "contained",
		...
		size: {
			name: "Size",
			description: "The size prop determines the height and padding of the button.",
			control: { type: "select" },
			options: ["large", "small"],
			table: {
				defaultValue: {
