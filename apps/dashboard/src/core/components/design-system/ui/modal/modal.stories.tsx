...
const meta: Meta<typeof ModalStory> = {
	...
	argTypes: {
		...
		title: {
			name: "Title",
			description: "The title of the modal. If not provided, the title will not be displayed.",
			control: { type: "text" },
		},
		hideCloseButton: {
			name: "Hide Close Button",
			description: "When true, the close button will not be displayed in the modal header.",
			control: { type: "boolean" },
		},
	},
};
...
const ModalStory = (props: { open: boolean; title: string; hideCloseButton: boolean }) => {
			...
			>
				<Box>
					<Box sx={{ padding: "16px 0" }}>
						This is an example of a modal component. You can put any content here.
					</Box>
