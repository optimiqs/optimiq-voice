...
import type { DataTableContextProps, DataTableContextProviderProps } from "./data-table.interfaces";

export const DataTableContext = createContext<DataTableContextProps<any> | null>(null);
