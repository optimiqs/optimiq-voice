...
/**
 * Hook to fetch the list of domains using the Optimiq Voice SDK.
 *
...
/**
 * Hook to fetch a specific domain by its reference using the Optimiq Voice SDK.
 *
...
/**
 * Hook to create a new domain using the Optimiq Voice SDK with optimistic UI updates.
 *
...
/**
 * Hook to update an existing domain using the Optimiq Voice SDK with optimistic UI support.
 *
...
/**
 * Hook to delete an domain by reference using the Optimiq Voice SDK with optimistic cache updates.
 *
