...
/**
 * Hook to fetch the list of agents using the Optimiq Voice SDK.
 *
...
/**
 * Hook to fetch a specific agent by its reference using the Optimiq Voice SDK.
 *
...
/**
 * Hook to create a new agent using the Optimiq Voice SDK with optimistic UI updates.
 *
...
/**
 * Hook to update an existing agent using the Optimiq Voice SDK with optimistic UI support.
 *
...
/**
 * Hook to delete an agent by reference using the Optimiq Voice SDK with optimistic cache updates.
 *
