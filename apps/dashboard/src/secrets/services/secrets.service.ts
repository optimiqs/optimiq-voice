...
/**
 * Hook to fetch the list of secrets using the Optimiq Voice SDK.
 *
...
/**
 * Hook to fetch a specific secret by its reference using the Optimiq Voice SDK.
 *
...
/**
 * Hook to create a new secret using the Optimiq Voice SDK with optimistic UI updates.
 *
...
/**
 * Hook to update an existing secret using the Optimiq Voice SDK with optimistic UI support.
 *
...
/**
 * Hook to delete an secret by reference using the Optimiq Voice SDK with optimistic cache updates.
 *
