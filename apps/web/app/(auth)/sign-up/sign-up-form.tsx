 ...
 *
 * `redirectTo` is carried through BOTH of those exits. The invitation screen sends new recipients
 * here with the invitation path on the query string, and dropping it strands them on the "create an
 * organization" screen with the invitation id gone from the URL.
 */
		...
		<AuthCard
			...
			footer={
				<>
					...
					<Link
						href={`${routes.signIn}?redirectTo=${encodeURIComponent(redirectTo)}`}
