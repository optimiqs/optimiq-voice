...
function createCredentials(credentials: CredentialsApi) {
	return createResource<CredentialsExtended, CreateCredentialsRequestExtended, CredentialsApi>(
		credentials,
		RESOURCE,
		V.createCredentialsRequestSchema,
	);
}

function updateCredentials(credentials: CredentialsApi) {
	return updateResource<CredentialsExtended, UpdateCredentialsRequest, CredentialsApi>(
		credentials,
		RESOURCE,
		V.updateCredentialsRequestSchema,
	);
}

function getCredentials(credentials: CredentialsApi) {
	return getResource<CredentialsExtended, BaseApiObject, CredentialsApi>(credentials, RESOURCE);
}

function listCredentials(credentials: CredentialsApi) {
	return listResources<CredentialsExtended, ListCredentialsRequest, CredentialsApi>(
		credentials,
		RESOURCE,
	);
}
...
function deleteCredentials(credentials: CredentialsApi) {
	return deleteResource<CredentialsExtended, BaseApiObject, CredentialsApi>(credentials, RESOURCE);
}
