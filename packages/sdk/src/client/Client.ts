import { ChannelCredentials, credentials, Interceptor, Metadata } from "@grpc/grpc-js";
...
const DEFAULT_ENDPOINT = "api.optimiq.health";
...
export class Client extends AbstractClient {
	...
	getCredentialsClient() {
		return new CredentialsServiceClient(this.endpoint, this.channelCredentials, {
			interceptors: [this.tokenRefresherInterceptor],
		});
	}
}
