...
/**
 * @classdesc Optimiq Voice Workspaces, part of the Optimiq Voice Identity subsystem,
...
class Workspaces {
	 ...
	 */
	async createWorkspace(request: CreateWorkspaceRequest): Promise<BaseApiObject> {
	...
	async getWorkspace(ref: string): Promise<Workspace> {
		const client = this.client.getIdentityClient();
		return await makeRpcRequest<GetWorkspaceRequestPB, WorkspacePB, BaseApiObject, Workspace>({
	 ...
	 *   .catch(console.error); // an error occurred
	 */
	async updateWorkspace(request: UpdateWorkspaceRequest): Promise<BaseApiObject> {
		const client = this.client.getIdentityClient();
		return await makeRpcRequest<
	 ...
	 *   .catch(console.error); // an error occurred
	 */
	async inviteUserToWorkspace(request: InviteUserToWorkspaceRequest): Promise<BaseApiObject> {
		const client = this.client.getIdentityClient();
		return await makeRpcRequest<
	 ...
	 *   .catch(console.error); // an error occurred
	 */
	async removeUserFromWorkspace(userRef: string): Promise<RemoveUserFromWorkspaceResponse> {
		const client = this.client.getIdentityClient();
		return await makeRpcRequest<
