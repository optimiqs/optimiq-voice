...
/**
 * @classdesc Optimiq Voice Users, part of the Optimiq Voice Identity subsystem,
...
class Users {
	 ...
	 *   .catch(console.error); // an error occurred
	 */
	async sendResetPasswordCode(request: SendResetPasswordCodeRequest): Promise<BaseApiObject> {
		const client = this.client.getIdentityClient();
		return await makeRpcRequest<
	...
	async resetPassword(request: ResetPasswordRequest): Promise<void> {
		const client = this.client.getIdentityClient();
		return await makeRpcRequest<ResetPasswordRequestPB, null, ResetPasswordRequest, never>({
