...
Optimiq Voice Acls, part of the Optimiq Voice SIP Proxy subsystem,
...
| ------ | ------------------------------- | ------------------------------------------------------------------------------------- |
| client | <code>OptimiqVoiceClient</code> | Client object with underlying implementations to make requests to Optimiq Voice's API |
...
Deletes an existing Acl from Optimiq Voice.
...
Optimiq Voice Agents, part of the Optimiq Voice SIP Proxy subsystem,
...
Deletes an existing Agent from Optimiq Voice.
Note that this operation is irreversible.
...
Optimiq Voice ApiKeys, part of the Optimiq Voice Identity subsystem,
...
Optimiq Voice Applications, part of the Optimiq Voice Voice Subsystem,
...
Creates a new Application in Optimiq Voice. The only required fields are the name and type of the application.
...
Updates an existing application in Optimiq Voice.
...
Retrieves a list of Applications from Optimiq Voice.
...
Deletes an existing Application from Optimiq Voice.
Note that this operation is irreversible.
...
Optimiq Voice Calls, part of the Optimiq Voice Media subsystem,
...
Optimiq Voice Credentials, part of the Optimiq Voice SIP Proxy subsystem,
...
Deletes an existing set of Credentials from Optimiq Voice.
Note that this operation is irreversible.
...
Optimiq Voice Domains, part of the Optimiq Voice SIP Proxy subsystem,
...
Optimiq Voice Numbers, part of the Optimiq Voice SIP Proxy subsystem,
...
Deletes an existing Number from Optimiq Voice.
Note that this operation is irreversible.
...
Optimiq Voice Secrets, part of the Optimiq Voice Core,
...
Optimiq Voice Trunks, part of the Optimiq Voice SIP Proxy subsystem,
...
const request = {
  ...
  sendRegister: true
  uris: [{
    host: "sip.company.optimiq.health",
    port: 5060,
    transport: "UDP",
    user: "user",
    weight: 0,
...
Deletes an existing Trunk from Optimiq Voice.
Note that this operation is irreversible.
...
Optimiq Voice Users, part of the Optimiq Voice Identity subsystem,
...
Deletes an existing User from Optimiq Voice.
Note that this operation is irreversible.
...
Optimiq Voice Workspaces, part of the Optimiq Voice Identity subsystem,
...
Deletes an existing Workspace from Optimiq Voice.
Note that this operation is irreversible.
