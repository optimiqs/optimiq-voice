...
function handleError(
	...
	const logAndCallback = (errorCode: number, errorMessage: string, logMessage: string) => {
	...
	switch (code) {
		...
		case grpc.status.NOT_FOUND:
			logAndCallback(status.NOT_FOUND, "The requested resource was not found", "not found error");
			break;
