...
import { exchangeCredentialsRequestSchema, GrpcErrorMessage } from "@optimiq-voice/common";
...
import { ExchangeCredentialsRequest, ExchangeResponse, IdentityConfig } from "./types";

const logger = getLogger({ service: "identity", filePath: __filename });

function createExchangeCredentials(db: Database, identityConfig: IdentityConfig) {
	...
	return withErrorHandlingAndValidation(exchangeCredentials, exchangeCredentialsRequestSchema);
}
