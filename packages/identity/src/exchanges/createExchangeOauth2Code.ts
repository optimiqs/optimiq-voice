...
import { exchangeOauth2RequestSchema, GrpcErrorMessage } from "@optimiq-voice/common";
...
import { ExchangeOauth2CodeRequest, ExchangeResponse, IdentityConfig } from "./types";

const logger = getLogger({ service: "identity", filePath: __filename });

function createExchangeOauth2Code(db: Database, identityConfig: IdentityConfig) {
	...
	return withErrorHandlingAndValidation(exchangeOauth2Code, exchangeOauth2RequestSchema);
}
