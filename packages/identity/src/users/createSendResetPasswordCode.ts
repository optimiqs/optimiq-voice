...
import { ContactType, SendResetPasswordCodeRequest } from "@optimiq-voice/types";
...
function createSendResetPasswordCode(db: Database, identityConfig: IdentityConfig) {
