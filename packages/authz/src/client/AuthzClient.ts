...
export class AuthzClient {
	...
	constructor(address: string) {
		this.client = new (grpc.makeGenericClientConstructor(serviceDefinition, "AuthzService", {}))(
			address,
	 ...
	 */
	async checkSessionAuthorized(request: Partial<VoiceRequest>): Promise<boolean> {
