...
func (v MediaSessionEndedReason) Valid() bool {
	return slices.Contains(MediaSessionEndedReasonValues, v)
}
...
func (v MediaPlaybackFinishedReason) Valid() bool {
	return slices.Contains(MediaPlaybackFinishedReasonValues, v)
}
...
func (v MediaRecordingFinishedReason) Valid() bool {
	return slices.Contains(MediaRecordingFinishedReasonValues, v)
}
...
func (v MediaRecordingFinishedDirection) Valid() bool {
	return slices.Contains(MediaRecordingFinishedDirectionValues, v)
}
