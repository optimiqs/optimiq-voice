...
[![Streams](https://img.shields.io/badge/streams-api-brightgreen.svg)](https://optimiq.health)
[![Version](https://img.shields.io/npm/v/@optimiq-voice/streams.svg)](https://npmjs.org/package/@optimiq-voice/streams)
[![Downloads/week](https://img.shields.io/npm/dw/@optimiq-voice/streams.svg)](https://npmjs.org/package/@optimiq-voice/streams)
[![License](https://img.shields.io/npm/l/@optimiq-voice/streams.svg)](https://github.com/optimiqs/optimiq-voice/blob/main/package.json)
...
```sh-session
$ npm install --save @optimiq-voice/streams
```

## Example

While the AudioSocket is a utility for Optimiq Voice Streams, it can be used as a standalone module. To use this library with Asterisk, you must configure your dialplan to use the `AudioSocket` application. Here is an example of how to use the AudioSocket with Asterisk:
...
```js
const { AudioSocket } = require("@optimiq-voice/streams");
